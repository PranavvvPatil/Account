...
export const HelpSupport = () => {
  ...
  return (
    <div className="w-[912px] h-[800px]">
    <div className=" flex-col p-12">
        <p className="text-black font-poppins text-lg font-semibold leading-normal">Hi , Williamson what can we help you with?</p>
    </div>

    <div className="w-[914px] h-[367px] flex flex-wrap flex-start ml-12 mt-5 gap-5 ">
    {config.map((item) => (
          <HelpSupport2 key={item.id} help ={item} />
        ))}
